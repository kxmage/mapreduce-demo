...
public class WbFactorMapper extends TableMapper<Text, IntWritable>{

	private static final String FAMILY_WEIBOINFO = "weiboinfo";
	...
	protected void map(ImmutableBytesWritable key, Result value, Context context)
					throws IOException, InterruptedException {
		// TODO Auto-generated method stub
		tmp_full_text = getString(value, FAMILY_WEIBOINFO, KEY_TEXT);
