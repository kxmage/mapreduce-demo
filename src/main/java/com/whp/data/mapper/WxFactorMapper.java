...
public class WxFactorMapper extends TableMapper<Text, IntWritable>{

	private static final String FAMILY_WEIXININFO = "weixininfo";
	...
	protected void map(ImmutableBytesWritable key, Result value, Context context)
					throws IOException, InterruptedException {
		// TODO Auto-generated method stub
		tmp_full_text = getString(value, FAMILY_WEIXININFO, KEY_TITLE) + getString(value, FAMILY_WEIXININFO, KEY_TEXT);
