...
import com.whp.data.mapper.VisitFactorMapper;
import com.whp.data.reducer.VisitFactorReducer;

public class VisitFactorRunner extends Configured implements Tool {

	private static final String HBASE_DATA_SOURCE = "HostVisitCount";
	...
	public int run(String[] args) throws Exception {
		...
		TableMapReduceUtil.initTableMapperJob(HBASE_DATA_SOURCE, scan, VisitFactorMapper.class, Text.class, IntWritable.class, job);
		
		//设置reduce输出路径
		FileOutputFormat.setOutputPath(job, new Path(args[0]));
		
		//设置mapper, combiner, reducer
		job.setMapperClass(VisitFactorMapper.class);
		job.setReducerClass(VisitFactorReducer.class);
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new VisitFactorRunner(), args));
	}
}
